#!/usr/bin/bash
#Let us say you want to   exit the script when an error is entered, let's use the set command. 

set -e 

#I created a variable in which the name of the user is going to be stored by prompting the user to enter his/her name.
#This variable will be used to name the folder where tools for the app to work will be located! 
...
echo "Trent, Git, submitted" >> submission_reminder_$NAME/assets/submissions.txt
echo "Stephanie, Shell Basics, not submitted" >> submission_reminder_$NAME/assets/submissions.txt
echo "Louis, Shell Navigation, not submitted" >> submission_reminder_$NAME/assets/submissions.txt
echo "Ebuka, Git, submitted" >> submission_reminder_$NAME/assets/submissions.txt
echo "Steven, Shell Basics, not submitted" >> submission_reminder_$NAME/assets/submissions.txt
echo "Gelim, Emacs, not submitted" >> submission_reminder_$NAME/assets/submissions.txt
echo "Pedri, vi, submitted" >> submission_reminder_$NAME/assets/submissions.txt
echo "Luka, vi, submitted" >> submission_reminder_$NAME/assets/submissions.txt
echo "Abraham, Git, not submitted" >> submission_reminder_$NAME/assets/submissions.txt
echo "David, Shell Navigation, submitted" >> submission_reminder_$NAME/assets/submissions.txt
echo "Spencer, Shell Basics, not submitted" >> submission_reminder_$NAME/assets/submissions.txt
echo "Victor, Shell Navigation, not submitted" >> submission_reminder_$NAME/assets/submissions.txt
echo "Mariam, Git, not submitted" >> submission_reminder_$NAME/assets/submissions.txt
